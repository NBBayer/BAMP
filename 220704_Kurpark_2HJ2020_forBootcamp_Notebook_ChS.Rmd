...
#summary(TFX_all)
heating_widemax$Zeit <- fastPOSIXct(heating_widemax$Zeit.x, required.components = 5L)
...
#Export to csv
write.csv(heating_widemax_TFX, "C:/Users/chris/Downloads/HotelamKurpark_2.HJ2020_heating_widemax_TFX_addData.csv")
...
1) Importing data set heating (Nov) aggregated on room level
